...
| Feature graphic (Play) | **1024×500** | ⬜ **required for Play listing** — Claude-Design |
| Screenshots | phone (+ tablet/iPad); iOS device sizes | ⬜ **required** — captured from real gameplay (landscape hero: a chaos wave, skill tree, a boss, the You-Won screen) |
| Short + full description | 80 / 4000 char | ⬜ text — "hold the center against robots from every side" angle |
